...
"%MINGW%/gcc.exe" -Wall -O3 %CFILES% -I%LUA%/src -I%SDL%/x86_64-w64-mingw32/include/SDL2 -L%LUA%/src -lluajit -L%SDL%/x86_64-w64-mingw32/lib -lSDL2 -lSDL2main -lws2_32 -o ../rein.exe
