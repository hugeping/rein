  ...
  { nam = 'synth',
    ...
    { 'type', synth.TYPE,
      ...
      choice = { 'sin', 'saw', 'square', 'dsf',
        'dsf2', 'pwm',
        'noise', 'lin_noise', 'band_noise', 'lin_band_noise',
      },
      vals = { synth.OSC_SIN, synth.OSC_SAW, synth.OSC_SQUARE, synth.OSC_DSF,
        synth.OSC_DSF2, synth.OSC_PWM,
        synth.OSC_NOISE, synth.OSC_LIN_NOISE,
        synth.OSC_BAND_NOISE, synth.OSC_LIN_BAND_NOISE,
      },
    },
--    { 'freq', synth.FREQ, def = 0 },
  ...
  { nam = 'dist',
    { "volume", synth.VOLUME, def = 0.5 },
    { "gain", synth.DIST_GAIN, def = 0.5 },
  },
  { nam = 'delay',
    { 'volume', synth.VOLUME,  def = 0.5 },
    { 'time', synth.DELAY_TIME, max = 1, min = 0, def = 1},
    { 'level', synth.DELAY_LEVEL, def = 0.5 },
    { 'feedback', synth.DELAY_FB, def = 0.5 },
  },
  { nam = 'filter' ,
    { 'volume', synth.VOLUME,  def = 0.5 },
    { 'mode', synth.FILTER_MODE, def = 'lowpass',
      choice = { 'lowpass', 'highpass' },
      vals = { synth.FILTER_LP, synth.FILTER_HP },
    },
    { 'width', synth.FILTER_WIDTH, def = 0.5 },
  },
}
