...
@voice 3 p8w0d
@voice 4 p8w0f
| d-1 82 | d-2 82 | c-1 ff | f-3 2f
@voice 2 p8w5v
| d-1 82 | d-2 82 | === .. | e-3 2f
| f-1 82 | === .. | ... .. | d-3 2f
| e-1 82 | d-2 82 | ... .. | e-3 2f
@voice 2 p8w5
| f-1 82 | d-2 82 | ... .. | f-3 2f
| e-1 82 | === .. | ... .. | e-3 2f
@voice 2 p8w5v
@voice 3 p8w6d
| d-1 82 | d-2 82 | c-2 82 | f-3 2f
| d-1 82 | d-2 82 | === .. | e-3 2f
@tempo 3
@voice 1 p8w5
| d-1 82 | === .. | ... .. | d-3 2f
...
@tempo 12
@voice 1 p8w5v
| d-1 82 | f-2 82 | ... .. | e-3 2f
| d-1 82 | e-2 82 | ... .. | f-3 2f
@voice 1 p8w5f
| d-1 82 | c-2 82 | ... .. | e-3 2f
@voice 3 p8w0d
| === .. | d-2 82 | c-1 ff | f-3 2f
@voice 1 p8w5v
| d-1 82 | d-2 82 | === .. | e-3 2f
| d-1 82 | === .. | ... .. | d-3 2f
| f-1 82 | d-2 82 | ... .. | e-3 2f
| e-1 82 | d-2 82 | ... .. | f-3 2f
| f-1 82 | === .. | ... .. | e-3 2f
@voice 3 p8w6d
| e-1 82 | d-2 82 | c-2 82 | f-3 2f
| d-1 82 | d-2 82 | === .. | e-3 2f
| d-1 82 | === .. | ... .. | d-3 2f
@voice 3 p8w3d
| d-1 82 | f-2 82 | c-2 82 | e-3 2f
| d-1 82 | e-2 82 | === .. | f-3 2f
| d-1 82 | a-1 82 | ... .. | e-3 2f
@voice 1 p8w5
@voice 2 p8w5
@voice 3 p8w0d
| c-1 82 | c-2 82 | c-1 82 | e-3 2f
@voice 1 p8w5v
@voice 2 p8w5v
| c-1 82 | c-2 82 | === .. | d-3 2f
| c-1 82 | === .. | ... .. | c-3 2f
| c-1 82 | c-2 82 | ... .. | d-3 2f
| c-1 82 | c-2 82 | ... .. | e-3 2f
| c-1 82 | === .. | ... .. | d-3 2f
@voice 3 p8w6d
| c-1 82 | c-2 82 | c-2 ff | e-3 2f
| c-1 82 | c-2 82 | === .. | d-3 2f
@tempo 6
| c-1 82 | c-2 82 | ... .. | e-3 2f
| c-1 82 | ... .. | ... .. | ... ..
| c-1 82 | f-2 82 | ... .. | d-3 2f
| c-1 82 | ... .. | ... .. | ... ..
| c-1 82 | e-2 82 | ... .. | c-3 2f
| c-1 82 | ... .. | ... .. | ... ..
| c-1 82 | a-1 82 | ... .. | d-3 2f
| c-1 82 | ... .. | ... .. | ... ..
@voice 2 p8w5
@voice 3 p8w0d
| c-1 82 | c-2 82 | c-1 ff | e-3 2f
| c-1 82 | ... .. | ... .. | ... ..
@voice 2 p8w5v
| c-1 82 | c-2 82 | === .. | d-3 2f
| c-1 82 | ... .. | ... .. | ... ..
...
| ... .. | === .. | ... .. | d-3 2f
@voice 3 p8w6d
| ... .. | e-2 82 | c-2 82 | e-3 2f
| ... .. | e-2 82 | === .. | d-3 2f
| ... .. | === .. | ... .. | e-3 2f
@voice 3 p8w3d
| ... .. | f-2 82 | c-2 82 | d-3 2f
| ... .. | f-2 82 | === .. | c-3 2f
| ... .. | === .. | ... .. | d-3 2f
@voice 2 p8w5
@voice 3 p8w0d
