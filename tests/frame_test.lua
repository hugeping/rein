...
describe("frame", function()
  ...
  it("menu_has_word finds standalone words only", function()
    ok(frame.menu_has_word("| New ", "New"))
    ok(frame.menu_has_word("|New", "New"))
    ok(frame.menu_has_word("| foo New bar", "New"))
    ok(not frame.menu_has_word("| newer", "New"))
    ok(not frame.menu_has_word("| fooNew", "New"))
    ok(not frame.menu_has_word("| foo", "New"))
    ok(not frame.menu_has_word(nil, "New"))
  end)
